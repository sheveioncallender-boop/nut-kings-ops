'use strict';
const CACHE = 'nut-kings-ops-v1.3.0';
const SHELL = [
  '/nutkings/',
  '/nut_kings_ops/static/workspace/app-v1.3.0.css',
  '/nut_kings_ops/static/workspace/app-v1.3.0.js',
...
self.addEventListener("install", event => event.waitUntil(caches.open("nutkings-roles-v1.3.0").then(cache => cache.add("/nut_kings_ops/static/workspace/roles-v1.3.0.css"))));

self.addEventListener("install", event => event.waitUntil(caches.open("nutkings-roles-v1.3.0").then(cache => cache.add("/nut_kings_ops/static/workspace/roles-v1.3.0.js"))));
