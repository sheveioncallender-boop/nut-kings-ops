...
function bindCleanFeatureEvents() {
  ...
  $('new-customer')?.addEventListener('click', () => openModal('customer-modal'));
...
async function init() {
  ...
  if ('serviceWorker' in navigator) {
    try {
      const registration = await navigator.serviceWorker.register('/nutkings/sw.js?v=1.0.0', { scope: '/nutkings/' });
