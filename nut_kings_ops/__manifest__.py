{'name': 'Nut Kings Ops',
 ...
 'assets': {'web.assets_backend': ['nut_kings_ops/static/src/scss/nut_kings_backend.scss'],
            'web.assets_frontend': ['nut_kings_ops/static/src/css/nutkings_login.css']},
